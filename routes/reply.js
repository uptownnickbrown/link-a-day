...
var buildResponse = function(reply, sendTo, linkTitle) {
  ...
  emailHTML = emailHTML + " + ' had something to say about your link. Reply to this email to keep the conversation going!</p>            <p class=\"quote\" style=\"font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; background-color: #f6f6f6; margin: 10px 20px; padding: 5px;\">";
